"""HTML parsing and text extraction from web pages."""
...
class TextExtractor(HTMLParser):
    """Extract plain text from HTML, skipping scripts, styles, and nav elements."""
...
def fetch_job_text(url: str, timeout: int = 15) -> str:
    ...
    Returns:
        Extracted plain text from the page, or error message if fetch fails.
    """
    headers = {
        "User-Agent": (
